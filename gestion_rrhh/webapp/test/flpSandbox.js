		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "RRHH",
									"targetURL": "#logaligroupgestionrrhh-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupgestionrrhh-display": {
								"semanticObject": "logaligroupgestionrrhh",
								"action": "display",
								"description": "RRHH",
								"title": "RRHH",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.gestionrrhh",
									"url": sap.ui.require.toUrl("logaligroup/gestionrrhh")
								}
							}
						}
					}
